...
?>
 ...
 <div class="box" id="box">
			...
			<?php
				...
				$slct = mysql_query("SELECT * FROM efg WHERE id='$id'");
				$ftch = mysql_fetch_array($slct);
			
   echo '<h3>Are you sure you want to remove '.$ftch['name'].'?</h3>
	<div style="float:right;">
		<a href="edit.php"><button class="btn btn-light" style="border: 1px solid gray; border-radius: 5px; background-color: #D4EAFF ">Cancel</button></a>
		<a href="remove_n.php?id='.$id.' "><button class="btn btn-light" id="h" style="border: 1px solid gray; border-radius: 5px;">Ok</button></a>
		</div>'; 
		?>
            </p>
			</div>
